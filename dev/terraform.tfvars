vsphere_user     = "mk417@lalux.local"
vsphere_password = "ShineAboef@2013#"
vsphere_server   = "lu309.lalux.local"

vsphere_network = "DMZ_TST_ESB"
vsphere_subnet = "172.22.74.0/24"
vsphere_content_library = "Linux_Templates_DC2"
vsphere_content_library_item = "RHEL8STD"
vsphere_folder = "/DMZ/DEV"
vsphere_vm_name = "lnx-test"
vsphere_machine_name = "TEST - LNX"
vsphere_vm_ip = "172.22.74.151"
vsphere_vm_gateway = "172.22.74.1"
vsphere_vm_satellite_env = "DEV_TEST"
vsphere_num_cpus = 1
vsphere_memory = 1024
vsphere_interface_name = "ens192"

vm_password = "L@lux0123456789#"
