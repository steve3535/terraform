...
with open(excel_filename,encoding="utf-8") as input_file:
    for line in input_file:
        ...
        vm[vm_nickname]={'vm_nickname':vm_nickname,'vm_name':vm_name.replace('\xa0',' '),'descr':descr.replace('\xa0',' '),'fqdn':fqdn,'datacenter':datacenter,'cluster':cluster,'image':image,'sub_cl':'',
